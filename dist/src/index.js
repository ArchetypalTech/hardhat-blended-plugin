...
Configuration:
  ...
  Fields:
    ...
    - interfacePath: The relative path to the Solidity interface that corresponds to the Rust contract. For example, "contracts/IMyContract.sol`).setAction(async (_, hre) => {
